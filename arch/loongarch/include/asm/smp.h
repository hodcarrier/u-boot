...
/**
 * loongarch_init_ipi() - Initialize inter-process interrupt (IPI) driver
 *
 * Platform code must provide this function. This function is called once after
 * the cpu driver is initialized. No other loongarch_*_ipi() calls will be made
...
/**
 * loongarch_send_ipi() - Send inter-processor interrupt (IPI)
 *
...
/**
 * loongarch_clear_ipi() - Clear inter-processor interrupt (IPI)
 *
 * Platform code must provide this function.
 *
...
/**
 * loongarch_get_ipi() - Get status of inter-processor interrupt (IPI)
 *
 * Platform code must provide this function.
 *
